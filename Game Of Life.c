...
void evolve(){
	...
	for(i=0; i<h; i++){
		for(j=0; j<w; j++){
			...
			left=j-1;right=j+1;//j=xMid
			top=i-1;down=i+1;//i=yMid
...
void pattern(int n, int x, int y){
	switch(n){
		...
		case 9://pulsar (period 3)
			set(5+x,3+y);set(6+x,3+y);set(7+x,3+y);//top
			set(5+x,8+y);set(6+x,8+y);set(7+x,8+y);//bottom
			set(3+x,5+y);set(3+x,6+y);set(3+x,7+y);//left
			set(8+x,5+y);set(8+x,6+y);set(8+x,7+y);//right
			
			set(5+x+6,3+y);set(6+x+6,3+y);set(7+x+6,3+y);//x+6
			set(5+x+6,8+y);set(6+x+6,8+y);set(7+x+6,8+y);//x+6
			set(3+x+7,5+y);set(3+x+7,6+y);set(3+x+7,7+y);//x+7
			set(8+x+7,5+y);set(8+x+7,6+y);set(8+x+7,7+y);//x+7
			
			set(5+x,3+y+7);set(6+x,3+y+7);set(7+x,3+y+7);//y+7
			set(5+x,8+y+7);set(6+x,8+y+7);set(7+x,8+y+7);//y+7
			set(3+x,5+y+6);set(3+x,6+y+6);set(3+x,7+y+6);//y+6
			set(8+x,5+y+6);set(8+x,6+y+6);set(8+x,7+y+6);//y+6
			
			set(5+x+6,3+y+7);set(6+x+6,3+y+7);set(7+x+6,3+y+7);//x+6 y+7
			set(5+x+6,8+y+7);set(6+x+6,8+y+7);set(7+x+6,8+y+7);//x+6 y+7
			set(3+x+7,5+y+6);set(3+x+7,6+y+6);set(3+x+7,7+y+6);//x+7 y+6
			set(8+x+7,5+y+6);set(8+x+7,6+y+6);set(8+x+7,7+y+6);//x+7 y+6
			break;
		case 10://block (still life)
			set(x,y);set(1+x,y);set(x,1+y);set(1+x,1+y);
			break;
		case 11://beehive (still life)
			set(1+x,y);set(2+x,y);
			set(x,1+y);set(3+x,1+y);
			set(1+x,y+2);set(2+x,y+2);
			break;
		case 12://loaf (still life)
			set(1+x,y);set(2+x,y);
			set(x,1+y);set(3+x,1+y);
			set(1+x,2+y);set(3+x,2+y);
			set(2+x,3+y);
			break;
		case 13://boat (still life)
			set(x,y);set(1+x,y);
			set(x,1+y);set(2+x,1+y);
			set(1+x,2+y);
			break;
		case 14://tub (still life)
			set(1+x,y);set(1+x,2+y);
			set(x,1+y);set(2+x,1+y);
			break;
